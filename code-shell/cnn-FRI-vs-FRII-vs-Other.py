...
def main(argv):
    ...
    for i in range(num_grp):
        fname = '../LRG-filter/data/lrg_171016/sample-lrg-train-140-120-c3-gr{0}.pkl'.format(i)
    ...
    X_test = []
    labels_test = []
    fname = '../LRG-filter/data/lrg_171016/sample-lrg-test-140-120-c3.pkl'
    with open(fname, 'rb') as fp:
        datadict = pickle.load(fp)
    ...
    mask_layer1 = [100,0,1,2,2,2,1,100]
    data_layer1,label_layer1 = sub2triple(data=X_in, label=X_out, mask=mask_layer1)
    label_layer1_hotpot = vec2onehot(label=label_layer1, numclass=3)
    ...
    foldname = "../nets/pretrain-171010-3cls/"
    name = "pretrain-120-171010-3cls.pkl"
    ...
    # save net
    foldname = "{0}/net_l2_140".format(subfold)
    name = "net_l2.pkl"
    netname = "model-l2.ckpt"
